...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <div style={{ paddingLeft: "2rem", paddingRight: "2rem", backgroundColor: "#FCF7F7", height: "100%" }}>
            {/* <Toolbar /> */}
            ...
            <List sx={{ gap: "0.5rem", display: "flex", flexDirection: "column" }}>
                {['Overview', 'Dashboard', 'Users', 'Calendar', 'Events', 'Projects', 'Overview', 'Overview', 'Overview'].map((text, index) => (
                    <ListItem sx={{ borderRadius: "0.5rem", height: "3rem" }} key={index} disablePadding>
